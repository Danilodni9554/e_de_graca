...
//regras de negocios: senha criptografada e token pra acessar
	...
	public Optional<Usuario> cadastrarUsuario(Usuario usuario) {
		...
		// throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Email ja
		// cadastrado", null);
	...
	public Optional<Usuario> atualizarUsuario(Usuario usuario) {
		...
		if (usuarioRepository.findByEmail(usuario.getEmail()).isPresent()) {
			...
			// throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Usuario não
			// encontrado", null);
	...
	public Optional<UsuarioLogin> loginUsuario(Optional<UsuarioLogin> usuarioLogin) {
		...
		// throw new ResponseStatusException(HttpStatus.UNAUTHORIZED, "E-mail ou senha
		// inválidos", null);
	}
